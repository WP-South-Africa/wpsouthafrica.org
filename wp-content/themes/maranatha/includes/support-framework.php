...
function maranatha_add_theme_support_framework() {
	...
	add_theme_support( 'ctfw-wordpress-version', '4.7' ); // 4.7 for get_theme_file_uri(); 4.3 at first release.
	...
	// Manually add download attribute to <a href="" download> tags for externally hosted files
	...
	add_theme_support( 'ctfw-widget-archives', array(
		...
		'field_overrides' => array(
			'post_type' => array( // explicitly set post type options that this theme provides an archive for
				'options' => array(
					'post'			=> _x( 'Blog', 'archives widget', 'maranatha' ),
